...
export default function Contact() {
    return (
        <>
            <section id='contact' className='lg:ml-[300px] py-10'>
                <div className='maxW'>

                    <p className="font-Rambla uppercase tracking-wider text-RedP text-center mt-10">Dúvidas?</p>
                    <h1 className="font-Pirata text-5xl uppercase text-center">Fale Conosco</h1>
                    ...
                    <div className='flex flex-col gap-4 lg:justify-between lg:items-center my-10 lg:flex-row'>
                        ...
                        <h1 className='text-center font-Pirata text-2xl tracking-wider mb-4'>Preencha e esclareça suas dúvidas!</h1>
                    ...
                    <h1 className="font-Pirata text-5xl uppercase text-center">Onde estamos?</h1>
                    {/* MAPS */}
                    <article>
