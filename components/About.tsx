...
export default function About() {
    return (
        <>
            <section id='about' className='lg:ml-[300px] py-20'>
                <div className='maxW flex flex-col justify-center gap-8 lg:flex-row '>
                    <article className='lg:w-1/2'>
                        ...
                        <h1 className='font-Pirata text-5xl uppercase'>O Canto da Chuleta</h1>
                        <p className='mt-6 text-gray-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam beatae dicta placeat sapiente maxime voluptate cumque ad ab, possimus praesentium asperiores officiis odit! Nulla harum maiores molestiae sint numquam facere quis, natus soluta laudantium cumque.</p>
                        <p className='mt-6 text-gray-400'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facere dicta harum consequatur molestias repellendus aliquid est accusamus incidunt quidem maiores, corporis doloremque nesciunt voluptates quasi assumenda debitis consequuntur dignissimos dolorum nam! At atque vero vitae temporibus ratione nobis aliquid praesentium!</p>
                        <p className='mt-6 text-gray-400'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, natus autem? Dolore id quo officiis corrupti, sapiente perferendis ipsa incidunt?</p>
