...
export default function Galery() {
  return (
    <>
      <section id='galery' className='lg:ml-[300px] py-20'>
        <div className='maxW'>
          <p className="font-Rambla uppercase tracking-wider text-RedP text-center">Chueleta</p>
          <h1 className="font-Pirata text-5xl uppercase text-center">Galeria</h1>
          ...
          <div className='flex items-center gap-2 rounded-lg text-xl bg-RedP py-2 px-6 max-w-[230px] mx-auto' >
            <a className='uppercase font-Pirata tracking-widest' href="https://www.instagram.com/cantodachuleta/">Sabores no Insta</a>
            <FaInstagram />
          </div>
